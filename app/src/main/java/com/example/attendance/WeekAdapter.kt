...
class WeekAdapter(
    context: Context,
    days: ArrayList<Date>
) : ArrayAdapter<Date>(context, R.layout.week_no_day, days) {
    // For view inflation
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        calendar.time = date
        val week_no = calendar.get(Calendar.WEEK_OF_YEAR)
        ...
        if (view == null)
            view = inflater.inflate(R.layout.week_no_day, parent, false)
...
//            }
//            week_no == calendarToday.get(Calendar.DATE) && month == calendarToday.get(Calendar.MONTH) && year == calendarToday.get(Calendar.YEAR) -> {
...
//            }
//            date == selectedDate || week_no == CalendarView.titletext.a2.date && month == CalendarView.titletext.a2.month && year == CalendarView.titletext.a2.toInstant().atZone(ZoneId.systemDefault()).toLocalDate().year-> {
...
//        }
        ...
        // Set text
        textView.text = week_no.toString()
